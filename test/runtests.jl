    ...
    @testset "MPE" begin
        ...
        @testset "Different matrix types" begin
            ...
            for prod! in (prod_1!, prod_2!, prod_3!)
                ...
                sol_MPE_tridiagonal_ip = solve(prob_tridiagonal_ip, MPE();
                                               dt, adaptive = false)
                sol_MPE_tridiagonal_op = solve(prob_tridiagonal_op, MPE();
                                               dt, adaptive = false)
                sol_MPE_dense_ip = solve(prob_dense_ip, MPE();
                                         dt, adaptive = false)
                sol_MPE_dense_op = solve(prob_dense_op, MPE();
                                         dt, adaptive = false)
                sol_MPE_sparse_ip = solve(prob_sparse_ip, MPE();
                                          dt, adaptive = false)
                sol_MPE_sparse_op = solve(prob_sparse_op, MPE();
                                          dt, adaptive = false)

                @test sol_MPE_tridiagonal_ip.t ≈ sol_MPE_tridiagonal_op.t
                @test sol_MPE_dense_ip.t ≈ sol_MPE_dense_op.t
                @test sol_MPE_sparse_ip.t ≈ sol_MPE_sparse_op.t
                @test sol_MPE_tridiagonal_ip.t ≈ sol_MPE_dense_ip.t
                @test sol_MPE_tridiagonal_ip.t ≈ sol_MPE_sparse_ip.t

                @test sol_MPE_tridiagonal_ip.u ≈ sol_MPE_tridiagonal_op.u
                @test sol_MPE_dense_ip.u ≈ sol_MPE_dense_op.u
                @test sol_MPE_sparse_ip.u ≈ sol_MPE_sparse_op.u
                @test sol_MPE_tridiagonal_ip.u ≈ sol_MPE_dense_ip.u
                @test sol_MPE_tridiagonal_ip.u ≈ sol_MPE_sparse_ip.u
            end
        end
    end
